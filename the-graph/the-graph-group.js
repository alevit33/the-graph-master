module.exports.register = function (context) {
  ...
  TheGraph.Group = React.createFactory( React.createClass({
    ...
    render: function() {
      ...
      var boxRectOptions = {
        x: x - this.props.item.metadata.spacing,
        y: y - this.props.item.metadata.spacing, //(this.props.spacing || 0),
        width: this.props.maxX - x + TheGraph.config.nodeWidth*0.5 + this.props.item.metadata.spacing*2,
        height: this.props.maxY - y + TheGraph.config.nodeHeight*0.75 + this.props.item.metadata.spacing * 2,
      ...
      var labelTextOptions = {
        ...
        y: y - this.props.item.metadata.spacing,
      ...
      var descriptionTextOptions = {
        x: x + TheGraph.config.nodeRadius,
        y: y + 24 - this.props.item.metadata.spacing,
